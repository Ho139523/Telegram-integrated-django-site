    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tel_group', models.CharField(blank=True, max_length=20, null=True, verbose_name='Telegram group ID')),
                ('tel_channel', models.CharField(blank=True, max_length=20, null=True, verbose_name='Telegram channel ID')),
